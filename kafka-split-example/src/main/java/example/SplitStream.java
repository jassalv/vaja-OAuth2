...
public class SplitStream
{
    ...
    public Topology buildTopology(Properties envProps){
        ...
        KStream<String, ActingEvent>[] branches = builder.<String, ActingEvent>stream(inputTopic)
                .branch((key, appearance) -> StringUtils.equalsIgnoreCase("drama",appearance.getGenre()),
                        (key, appearance) -> StringUtils.equalsIgnoreCase("fantasy",appearance.getGenre()),
                        (key, appearance) -> true);
    ...
    public static void main( String[] args ) throws IOException {
        ...
        Properties streamProps = ss.buildStreamProperties(envProps);
